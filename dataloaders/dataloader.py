...
class iCUB(iIMAGENET_R):
    ...
    def load(self):
        ...
        # load splits from config file
        if self.train or self.validation:
            data = datasets.ImageFolder('/data/scratch/projects/punim1942/continual_data/cub/train')
        else:
            data = datasets.ImageFolder('/data/scratch/projects/punim1942/continual_data/cub/test')
